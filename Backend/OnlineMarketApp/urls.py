...
from .views import ShoesListView, KidsWearListView, MensWearListView, ElectronicsListView, ProductsListView, FashionListView, HeroListView, TopProductsListView, SubscribeView
