...
const PaymentDetails = ({ onPaymentSelect }) => {
          ...
          {selectedMethod !== 'cash' && (
            <div className="mt-4 space-y-3">
              ...
              {selectedMethod === 'bank' && (
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p><span className="font-medium">Account Name:</span> Your Business Name</p>
                    <p><span className="font-medium">Account Number:</span> 1234567890</p>
                    <p><span className="font-medium">Branch:</span> Main Branch</p>
                    <p className="text-xs text-gray-500 mt-2">Use your order ID as the reference.</p>
                  </div>
                </div>
              )}
              ...
              <button 
                ...
                onClick={() => alert(`Processing ${selectedMethod} payment...`)}
              >
